...
export class ConfirmationComponent implements OnInit {
  ...
  confirmationData!: Stepper;

  constructor(private sharedDataService: StepperDataService) {
  ...
  getOrderDetails(): OrderDetails {
    ...
    const userInfoData = JSON.parse(
      localStorage.getItem('userInfoFormData') || '{}'
    );
...
${this.orderDetails.shippingAddress.city}, ${
      this.orderDetails.shippingAddress.zipCode
    }
